                ...
                <div class="thanks-section">
                    ...
                    <div class="sponsor-grid">
                        <div class="sponsor-column">
                            ...
                            <h4 style="color: #6B73FF; margin: 10px 0;">Corporate</h4>
                            <ul class="sponsor-list">
                                <li>Batterfly - ESG Tech Company</li>
                            </ul>
                        </div>
                        <div class="sponsor-column">
...
def main():
    ...
    print(f"Found {total_people} people to email. The script will wait for 1 minute after each batch of {batch_size}.")
    ...
    for i in range(0, total_people, batch_size):
        ...
        if i + batch_size < total_people:
            try:
                print("\nWaiting for 1 minute before sending the next batch... (Press Ctrl+C to exit)")
                time.sleep(60)
